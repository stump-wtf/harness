...
own skill directory cannot mutate a shared source. Skill repos declared for
distillation (SPEC-0007) SHALL be excluded from projection unconditionally. Projection
